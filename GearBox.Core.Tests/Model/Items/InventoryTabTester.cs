...
public class InventoryTabTester
{
    ...
    [Fact]
    public void Add_GivenPart_DoesNotSum()
    {
        var sut = new InventoryTab<Part>();
        var item1 = new Part("foo", PartSlotType.ALL.First());
        var item2 = new Part("foo", PartSlotType.ALL.First());
