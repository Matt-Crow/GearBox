...
public class ItemShopTester
{
    ...
    {
        var item = ItemUnion.OfMaterial(new Material("foo"));
    ...
    {
        var item = ItemUnion.OfMaterial(new Material("foo material"));
        var player = MakePlayer(item);
    ...
    private static ItemUnion MakeItem(string? name = null) => ItemUnion.OfMaterial(new Material(name ?? "a material"));
